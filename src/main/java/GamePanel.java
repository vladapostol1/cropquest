...
import main.java.asset.AssetManager;
import main.java.asset.entity.Entity;
import main.java.asset.entity.monster.MON_GreenSlime;
import main.java.asset.tile.TileManager;
import main.java.event.EventHandler;
import main.java.sound.SoundManager;
import main.java.ui.UI;
import main.java.util.KeyHandler;
import main.java.asset.entity.player.Player;
import main.java.asset.object.Object;
import main.java.asset.tile.interactive.InteractiveTile;
import main.java.util.CollisionChecker;
...
public class GamePanel extends JPanel implements Runnable {
    ...
    private void drawDebugInfo(Graphics2D graphics2D) {
        int x = 10;
        int y = 400;
        int lineHeight = 20;
    ...
    public void reloadMap(int difficulty){
        switch (difficulty){
            case 0:
                ...
                tileManager.loadMap("/maps/map_0.txt", 0);
                assetManager.setMonsters();
                assetManager.setObjects();
                assetManager.setInteractiveTiles();
                break;
            case 1:
                ...
                assetManager.setObjects();
                assetManager.setInteractiveTiles();
                tileManager.loadMap("/maps/map_1.txt", 0);
                break;
            case 2:
                this.difficulty = difficulty;
                assetManager.setMonsters();
                assetManager.setObjects();
                assetManager.setInteractiveTiles();
                tileManager.loadMap("/maps/map_2.txt", 0);
                break;
        }
    }
