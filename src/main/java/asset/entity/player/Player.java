package main.java.asset.entity.player;
...
import main.java.asset.object.usable.pickuponly.PickUpOnlyObject;
import main.java.util.KeyHandler;
import main.java.asset.object.equipment.*;
...
public class Player extends Entity {
    ...
    public void setItems() {
        ...
        getInventory().add(new OBJ_WaterCan(getGamePanel()));
        getInventory().add(new OBJ_Hoe(getGamePanel()));
    }
    ...
    private void setDefaultWeapon() {
        setCurrentWeapon(new OBJ_Axe(getGamePanel()));
        setPlayerAttackArea();
        getAttackImages();
    }
    ...
    public void getAnimationImages() {
        setUp1(setup("/images/player/player_up_1", getGamePanel().getTileSize(), getGamePanel().getTileSize()));
        setUp2(setup("/images/player/player_up_3", getGamePanel().getTileSize(), getGamePanel().getTileSize()));
        setDown1(setup("/images/player/player_down_1", getGamePanel().getTileSize(), getGamePanel().getTileSize()));
        setDown2(setup("/images/player/player_down_3", getGamePanel().getTileSize(), getGamePanel().getTileSize()));
        setLeft1(setup("/images/player/player_left_1", getGamePanel().getTileSize(), getGamePanel().getTileSize()));
        setLeft2(setup("/images/player/player_left_3", getGamePanel().getTileSize(), getGamePanel().getTileSize()));
        setRight1(setup("/images/player/player_right_1", getGamePanel().getTileSize(), getGamePanel().getTileSize()));
        setRight2(setup("/images/player/player_right_3", getGamePanel().getTileSize(), getGamePanel().getTileSize()));
    }

    public void getAttackImages() {
        if (getCurrentWeapon() instanceof OBJ_Axe) {
            setAttackUp1(setup("/images/player/player_axe_up_1", getGamePanel().getTileSize(), getGamePanel().getTileSize() * 2));
            setAttackUp2(setup("/images/player/player_axe_up_2", getGamePanel().getTileSize(), getGamePanel().getTileSize() * 2));
            setAttackDown1(setup("/images/player/player_axe_down_1", getGamePanel().getTileSize(), getGamePanel().getTileSize() * 2));
            setAttackDown2(setup("/images/player/player_axe_down_2", getGamePanel().getTileSize(), getGamePanel().getTileSize() * 2));
            setAttackLeft1(setup("/images/player/player_axe_left_1", getGamePanel().getTileSize() * 2, getGamePanel().getTileSize()));
            setAttackLeft2(setup("/images/player/player_axe_left_2", getGamePanel().getTileSize() * 2, getGamePanel().getTileSize()));
            setAttackRight1(setup("/images/player/player_axe_right_1", getGamePanel().getTileSize() * 2, getGamePanel().getTileSize()));
            setAttackRight2(setup("/images/player/player_axe_right_2", getGamePanel().getTileSize() * 2, getGamePanel().getTileSize()));
        }

        if (getCurrentWeapon() instanceof OBJ_Hoe) {
            setAttackUp1(setup("/images/player/player_hoe_up_1", getGamePanel().getTileSize(), getGamePanel().getTileSize() * 2));
            setAttackUp2(setup("/images/player/player_hoe_up_2", getGamePanel().getTileSize(), getGamePanel().getTileSize() * 2));
            setAttackDown1(setup("/images/player/player_hoe_down_1", getGamePanel().getTileSize(), getGamePanel().getTileSize() * 2));
            setAttackDown2(setup("/images/player/player_hoe_down_2", getGamePanel().getTileSize(), getGamePanel().getTileSize() * 2));
            setAttackLeft1(setup("/images/player/player_hoe_left_1", getGamePanel().getTileSize() * 2, getGamePanel().getTileSize()));
            setAttackLeft2(setup("/images/player/player_hoe_left_2", getGamePanel().getTileSize() * 2, getGamePanel().getTileSize()));
            setAttackRight1(setup("/images/player/player_hoe_right_1", getGamePanel().getTileSize() * 2, getGamePanel().getTileSize()));
            setAttackRight2(setup("/images/player/player_hoe_right_2", getGamePanel().getTileSize() * 2, getGamePanel().getTileSize()));
        }

        if (getCurrentWeapon() instanceof OBJ_WaterCan) {
            setAttackUp1(setup("/images/player/player_watercan_up_1", getGamePanel().getTileSize(), getGamePanel().getTileSize() * 2));
            setAttackUp2(setup("/images/player/player_watercan_up_2", getGamePanel().getTileSize(), getGamePanel().getTileSize() * 2));
            setAttackDown1(setup("/images/player/player_watercan_down_1", getGamePanel().getTileSize(), getGamePanel().getTileSize() * 2));
            setAttackDown2(setup("/images/player/player_watercan_down_2", getGamePanel().getTileSize(), getGamePanel().getTileSize() * 2));
            setAttackLeft1(setup("/images/player/player_watercan_left_1", getGamePanel().getTileSize() * 2, getGamePanel().getTileSize()));
            setAttackLeft2(setup("/images/player/player_watercan_left_2", getGamePanel().getTileSize() * 2, getGamePanel().getTileSize()));
            setAttackRight1(setup("/images/player/player_watercan_right_1", getGamePanel().getTileSize() * 2, getGamePanel().getTileSize()));
            setAttackRight2(setup("/images/player/player_watercan_right_2", getGamePanel().getTileSize() * 2, getGamePanel().getTileSize()));
        }
    }
